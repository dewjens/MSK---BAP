        ...
        this.setState({
          items: [
            <span className={style.subTitle}>
              De middeleeuwse stad, een belangrijk wederkend onderwerp in vele
              werken op de expositie.
            </span>,
          ],
        }),
      3000,
    ...
    setTimeout(
      () =>
        this.setState({
          items: [
            <span className={style.subTitle}>
              Klassieke gebouwen, rumoerige marktjes en de vele handelaren. Een
              mysterieus raadsel.
            </span>,
          ],
        }),
    ...
    setTimeout(
      () =>
        this.setState({
          items: [
            <span className={style.subTitle}>
              Baan je een weg door de middeleeuwse straatjes en ontdek waarom de
              middeleeuwse stad zo belangrijk voor veel kunstenaars was.
            </span>,
          ],
        }),
      13000,
          ...
          {isHidden =>
            ...
            (props => (
              <div style={props} className={style.themeSection}>
                ...
                <div onClick={this.toThema1.bind(this)} className={`${style.theme} ${style.theme1}`} >
                ...
                <div onClick={this.toThema2.bind(this)} className={`${style.theme} ${style.theme2}`} >
                  <div className={style.playBtnWrapper}>
                    <div className={style.playBtn} />
                  </div>
                  <div className={style.ontdek}>
          ...
          {show =>
            ...
            (props => (
              <div style={props}>
                ...
                <span onClick={this.closeThema1.bind(this)} className={style.skipThema}>
                  Bekijk de werken
                </span>
            ...
            (props => (
              <div style={props}>
                <section className={style.alterThemepicker}>
                  <div className={style.themePicker} onClick={this.toggleHidden.bind(this)}>
                    <img src={Backthema}/>
                    <span className={style.themeBack}>Terug</span>
                  </div>
                  <ul className={style.themeAlter}>
                    <li onClick={this.switchtoThema1.bind(this)} className={`${style.themeAlterItem} ${style.active}`}>Middeleeuwse stad</li>
                    <li onClick={this.switchtoThema2.bind(this)} className={style.themeAlterItem}>Beeldhouwkunst</li>
                    <li className={style.themeAlterItem}>Middeleeuws Landschap</li>
                  </ul>
                </section>
                <Thema1Selector />
          ...
          {show =>
            ...
            (props => (
              <div style={props}>
                ...
                <span onClick={this.closeThema2.bind(this)} className={style.skipThema}>
                  Bekijk de werken
                </span>
            ...
            (props => (
              <div style={props}>
                <section className={style.alterThemepicker}>
                  ...
                  <ul className={style.themeAlter}>
                    <li onClick={this.switchtoThema1.bind(this)} className={style.themeAlterItem}>Middeleeuwse stad</li>
                    <li onClick={this.switchtoThema2.bind(this)} className={`${style.themeAlterItem} ${style.active}`}>Beeldhouwkunst</li>
                    <li className={style.themeAlterItem}>Middeleeuws Landschap</li>
                  </ul>
                </section>
                <Thema2Selector />
